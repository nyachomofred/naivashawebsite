...
<div class="page-header header-filter header-small myAllignment" data-parallax="true" style=" background-image: url('resources/mathemathics/{{$page->bg_image}}'); ">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-md-10 ml-auto mr-auto">
                <h2 class="title">Mathemathics</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card-header card-header-image">
                                <img class="img img-raised" src="resources/mathemathics/{{$page->hod_pic}}">
