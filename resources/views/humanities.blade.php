...
<div class="page-header header-filter header-small myAllignment" data-parallax="true" style=" background-image: url('resources/humanities/{{$page->bg_image}}'); ">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card-header card-header-image">
                                <img class="img img-raised" src="resources/humanities/{{$page->hod_pic}}">
