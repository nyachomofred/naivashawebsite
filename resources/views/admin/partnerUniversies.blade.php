         ...
         <td>
              ...
              <div class="item-actions" style="padding-right: 40px;">
                  ...
                  <button type="button" class="btn btn-sm btn-default dropdown-toggle" style="padding: 2px 8px 0 8px;"
                   ...
                   <form method="post" action="{{url('/editPartner')}}">
                   @csrf   
                   ...
                   <form method="post" action="{{url('/deletePartner')}}">
                   @csrf   
                   <input type="hidden" name="id" value="{{$user->id}}" />
                   <li>
                   <button onclick="return confirm('Do you really want to delete this partner')" class="buttontext" type="submit">&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-trash"></i>  Delete</button>
                   </form>
                  </li>
