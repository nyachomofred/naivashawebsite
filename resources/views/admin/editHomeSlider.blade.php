...
<div class="box ">
    ...
    <div class="box-body">
        ...
        @endif                
              ...
              <form method="POST" enctype="multipart/form-data" action="{{url('updateHomeSlider')}}"> 
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="title" name="title">
                            {{$user->title}}
                        </textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="description" name="content">
                            {{$user->content}}
                        </textarea>
                    </div>
                    ...
                    <div class="col-md-12 text-right">
                         <br/>
                        <div class="form-group"><button class="btn btn-success" type="submit"><i class="fa fa-save"></i> Create [Home Slider]</button>&nbsp;&nbsp;<a class="btn btn-warning" href="{{url('/sliders')}}"><i class="fa fa-times"></i> Cancel</a></div>
                </div>    
                </form>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12 mt-2 text-center">
                        <h4 class="mb-2">Slider Image</h4>
                          <img src="resources/sliders/{{$user->url}}" class="rounded mx-auto d-block"
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="exampleModalLabel">Slider Image</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateSliderImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
