...
<div class="box ">
    ...
    <div class="box-body">
                 ...
                 <div class="alert alert-danger">{{$error}}</div>
                  @endforeach
                  @endif
         <form method="post" action="{{url('/updateExaminations')}}">
          @csrf                          
                <div class="row">
                    <div class="col-md-12">
                    <div class="col-md-4">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="content">HOD Name</label>
                        <textarea class="form-control" placeholder="HOD name" name="hod_name">
                          {{$page->hod_name}}
                        </textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control my-editor" rows="10"  id="content" name="brief_desc" cols="50">{{$page->brief_desc}}
                        </textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control my-editor" rows="10"  id="content" name="more_about_dep" cols="50">{{$page->more_about_dep}}
                        </textarea>
                    </div>
                ...
                <hr/>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <h4>Background Image</h4>
                          <img src="resources/examinations/{{$page->bg_image}}" class="rounded mx-auto d-block"
                  ...
                  <div class="modal fade" id="bg_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateExaminationsBackgroundImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                    ...
                    <div class="col-md-12 mt-2">
                        <h4>HOD Picture</h4>
                          <img src="resources/examinations/{{$page->hod_pic}}" class="rounded mx-auto d-block"
                               height="150" alt="image">
                  ...
                  <div class="modal fade" id="disp_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="exampleModalLabel">HOD Picture</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateExaminationsImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="page_id" value="{{$page->id}}">
