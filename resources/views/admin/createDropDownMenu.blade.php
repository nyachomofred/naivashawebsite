...
<div class="box box-primary">
    ...
    <div class="box-body" style="min-height: 350px;">
            ...
            <form method="POST" action="{{url('/createDropDownMenu1')}}">
              @csrf
            ...
            <input class="form-control " name="url"  type="text" value="#" readonly="readonly"  required autofocus />
            </div>
            ...
            <div class="form-group  text-right" style="padding-top: 50px;"><button class="btn btn-success" type="submit"><i class="fa fa-fw fa-save"></i> Create [Drop Down Menu]</button>&nbsp;&nbsp;<a class="btn btn-warning" href="{{url('/menu')}}"><i class="fa fa-times"></i> Cancel</a></div>
