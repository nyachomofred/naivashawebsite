...
<div class="box ">
    ...
    <div class="box-body">
                 ...
                 <div class="alert alert-danger">{{$error}}</div>
                  @endforeach
                  @endif
         <form method="post" action="{{url('/updateCocuriculor')}}">
          @csrf                          
                <div class="row">
                    <div class="col-md-12">
                    <div class="col-md-4">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="content">More about Department</label>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <h4>Background Image</h4>
                          <img src="resources/cocurriculor/{{$page->bg_image}}" class="rounded mx-auto d-block"
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateCocurriculorBackgroundImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
