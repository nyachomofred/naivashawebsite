...
<div class="box ">
    ...
    <div class="box-body">
                 ...
                 <div class="alert alert-danger">{{$error}}</div>
                  @endforeach
                  @endif
         <form method="post" action="{{url('/updateAnthem')}}">
          @csrf                          
                <div class="row">
                    <div class="col-md-12">
                    <div class="col-md-4">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control my-editor" rows="10" placeholder="verse1" id="content" name="verse1" cols="50">{{$page->verse1}}
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label for="chorus">Chorus</label>
                        <textarea class="form-control my-editor" rows="10" placeholder="chorus" id="content" name="chorus" cols="50">{{$page->chorus}}
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label for="verse2">Verse 2</label>
                        <textarea class="form-control my-editor" rows="10" placeholder="verse2" id="content" name="verse2" cols="50">{{$page->verse2}}
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label for="verse3">Verse 3</label>
                        <textarea class="form-control my-editor" rows="10" placeholder="verse3" id="content" name="verse3" cols="50">{{$page->verse3}}
                        </textarea>
                    </div>
                ...
                <hr/>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <h4>Background Image</h4>
                          <img src="resources/anthem/{{$page->bg_image}}" class="rounded mx-auto d-block"
                  ...
                  <div class="modal fade" id="bg_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateAnthemBackgroundImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                    ...
                    <div class="col-md-12 mt-2">
                        <h4>Anthem Image</h4>
                          <img src="resources/anthem/{{$page->image1}}" class="rounded mx-auto d-block"
                               height="150" alt="image">
                  ...
                  <div class="modal fade" id="disp_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="exampleModalLabel">Update Anthem Image</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateAnthemImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="page_id" value="{{$page->id}}">
