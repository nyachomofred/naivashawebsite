               ...
               <div class="mail-header row">
                 ...
                 <div class="col-md-4" style="padding-left:150px;">
                   <div class="compose-btn pull-right">
                     <a href="{{ url('/newRedirect') }}" class="btn btn-sm btn-theme"><i class="fa fa-reply"></i> Back</a>
                     <button class="btn  btn-sm tooltips" data-original-title="Print" type="button" data-toggle="tooltip" data-placement="top" title=""><i class="fa fa-print"></i> </button>
                     <a href="#"> <button class="btn btn-sm tooltips" data-original-title="Trash" data-toggle="tooltip" data-placement="top" title=""><i class="fa fa-trash-o"></i></button></a>
                   </div>
                 </div>
               </div>
