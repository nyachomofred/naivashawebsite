...
<div class="box ">
    ...
    <div class="box-body">
              <form method="POST" enctype="multipart/form-data" action="{{url('/createTeam1')}}"> 
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Team Name" required>
                    </div>
