...
<div class="box ">
    ...
    <div class="box-body">
              <form method="POST" enctype="multipart/form-data" action="{{url('createEventsSlider1')}}"> 
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <br/>
                        <div class="form-group"><button class="btn btn-success" type="submit"><i class="fa fa-save"></i> Create [Events Slider]</button>&nbsp;&nbsp;<a class="btn btn-warning" href="{{url('/sliders')}}"><i class="fa fa-times"></i> Cancel</a></div>
                    </div>
                </div>    
                </div>
                </form>
