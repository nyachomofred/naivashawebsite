                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="content">Background Image Text</label>
                        <textarea class="form-control my-editor" id="content" name="bg_text">
                          {{$page->bg_text}}
                        </textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="content">Our History</label>
                        <textarea class="form-control my-editor" rows="10"  id="content" name="brief_intro" cols="50">{{$page->brief_intro}}
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label for="content">Introduction Text</label>
                        <textarea class="form-control my-editor" id="content" name="intro_text">
                          {{$page->intro_text}}
                        </textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="content">The school</label>
                        <textarea class="form-control my-editor" rows="10"  id="content" name="school" cols="50">{{$page->school}}
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label for="content">History</label>
                        <textarea class="form-control my-editor" rows="10"  id="content" name="history" cols="50">{{$page->history}}
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label for="content">Performace</label>
                        <textarea class="form-control my-editor" rows="10"  id="content" name="performance" cols="50">{{$page->performance}}
                        </textarea>
                    </div>
                ...
                <hr/>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <h4>Background Image</h4>
                          <img src="resources/history/{{$page->bg_image}}" class="rounded mx-auto d-block"
                  ...
                  <div class="modal fade" id="bg_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateHistoryBackgroundImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                    ...
                    <div class="col-md-12 mt-2">
                        <h4>School Picture</h4>
                          <img src="resources/history/{{$page->school_pic}}" class="rounded mx-auto d-block"
                               height="150" alt="image">
                  ...
                  <div class="modal fade" id="disp_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="exampleModalLabel">School Picture</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateHistoryImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="page_id" value="{{$page->id}}">
                    ...
                    <!--Subjects image-->
                    <div class="col-md-12 mt-2">
                        <h4>History Picture</h4>
                          <img src="resources/history/{{$page->history_pic}}" class="rounded mx-auto d-block"
                               height="150" alt="image">

                          <div class="col-md-12">
                            <button type="button" class="btn btn-success modalButton" data-toggle="modal" title="Update Image" data-target="#disp_image1">
                               <i class="fa fa-edit" aria-hidden="true" style="font-size:20px"></i>
                            </button>
                          </div>
                    </div>
                  ...
                  <div class="modal fade" id="disp_image1" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title" id="exampleModalLabel">History Picture</h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateHistoryImage1')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="page_id" value="{{$page->id}}">
