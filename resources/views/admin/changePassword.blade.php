                    ...
                    <div class="tab-pane  active " id="profile">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="{{url('/changePassword')}}"><i
                            ...
                            <div class="tab-content">
                                ...
                                <form method="POST" action="{{url('/changePassword1')}}">
                                  @csrf
                                  
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group   required-field "><label for="name">Old Password</label><input class="form-control " name="oldpass" type="password" required autofocus></div>

                                            <div class="form-group   required-field "><label for="email">NewPassword</label><input class="form-control "  name="password" type="password" required autofocus></div>
                                        ...
                                        <div id="country-div" class="col-md-4">
                                            ...
                                            <div class="form-group   required-field "><label for="last_name">Confirm New Password</label><input class="form-control " 
                                             name="password_confirmation"  type="password" required autofocus></div>
                                        </div>
