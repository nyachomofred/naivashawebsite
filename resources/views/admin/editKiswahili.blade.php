...
<div class="box ">
    ...
    <div class="box-body">
                 ...
                 <div class="alert alert-danger">{{$error}}</div>
                  @endforeach
                  @endif
         <form method="post" action="{{url('/updateKiswahili')}}">
          @csrf                          
                <div class="row">
                    <div class="col-md-12">
                    <div class="col-md-4">
                ...
                <hr/>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <h4>Background Image</h4>
                          <img src="resources/kiswahili/{{$page->bg_image}}" class="rounded mx-auto d-block"
                  ...
                  <div class="modal fade" id="bg_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateKiswahiliBackgroundImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                    ...
                    <div class="col-md-12 mt-2">
                        <h4>HOD Picture</h4>
                          <img src="resources/kiswahili/{{$page->hod_pic}}" class="rounded mx-auto d-block"
                               height="150" alt="image">
                  ...
                  <div class="modal fade" id="disp_image" tabindex="-1" role="dialog" 
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method="post" action="{{url('/updateKiswahiliImage')}}" class="form-horizontal" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="page_id" value="{{$page->id}}">
