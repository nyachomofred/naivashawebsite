                 ...
                 <div class="alert alert-danger">{{$error}}</div>
                  ...
                  <div class="alert alert-success">{{session('success')}}</div>
                     @endif
                            ...
                            @if(($menu->key=="logo")||($menu->key=="fav-icon")||($menu->key=="footer-image"))
                                 <tr>
                                        <td>{{$menu->name}}</td>
                                        <td><img src="resources/settings/{{$menu->data}}" alt="images" height="50" width="70" /></td>
                                        <td>{{$menu->updated_at}}</td>
                                        <td>
                                             <form method="post" action="{{url('/updateImageSettings')}}">
                                                 @csrf
