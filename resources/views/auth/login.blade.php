...
@section('content')
            ...
            <div class="col-xs-12 text-center login-box-msg">
              <img src="http://localhost/naivasha/public/resources/settings/NaivashaLogo.png" height="100" alt="Logo">
            </div>
            <h4 class="login-box-msg">Welcome to Naivasha Girls Secondary</h4><br/>
        <div class="row">
